...
class TestRTMetrics(unittest.TestCase):
    ...
    @staticmethod
    def mock_series():
        d1 = pd.Series([43.04, 20.55, 8.98, -15.27, 29.18, -12.48, 78.35,
                        92.73, -23.31, 14.12])
        d2 = pd.Series([11.52, 116.34, 60.88, 9.73, 35.51, 26.69, 119.53,
                        -16.41, 25.05, -68.33])
        results = {
    ...
    def test_linregress(self):
        ...
        self.assertAlmostEqual(linregress['slope'],
    ...
    def test_fit_metric(self):
        ...
        for [p1, s1], [p2, s2] in combinations(
                fit.metric._all_keys.items(), 2):
            ...
            for metric in RTmetrics.metrics_registry:
                ...
                assertmsg = ("there's been something wrong during metric-evaluation!\n"
