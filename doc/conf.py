...
project = "Bistatic first order scattering model"
copyright = "2016, Raphael Quast, Alexander Loew"
...
latex_documents = [
    (
        "index",
        "Bistaticfirstorderscatteringmodel.tex",
...
man_pages = [
    (
        "index",
        "bistaticfirstorderscatteringmodel",
        "Bistatic first order scattering model Documentation",
        ["Raphael Quast, Alexander Loew"],
        1,
    )
